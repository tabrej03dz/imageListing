@extends('backend.layout.root', ['title' => 'Downloads'])
@section('content')
    <div class="row justify-content-between my-2">
        ...
        <div class="col-md-4">
            <form action="{{route('downloads.view')}}" method="get"
            ...
            <li class="nav-item dropdown no-arrow d-sm-none">
                ...
                <div class="dropdown-menu dropdown-menu-right p-3 shadow animated--grow-in"
                    ...
                    <form action="{{route('downloads.view')}}" method="get" class="form-inline mr-auto w-100 navbar-search">
                        @csrf
                        <div class="input-group">
    ...
    <table class="table table-bordered">
        ...
        <tr>
            ...
            <th class="p-1">Image Title</th>
            <th class="p-1">Image Date</th>
            <th class="p-1">Count</th>
            <th class="p-1">Downloaded At</th>
        </tr>
        </thead>
        <tbody>
