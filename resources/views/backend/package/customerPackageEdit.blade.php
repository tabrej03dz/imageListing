    ...
    <div class="card shadow mb-4 p-5">
        ...
        <div class="row justify-content-around">
            <div class="col-md-8">
                ...
                <form action="{{ route('package.ofCustomer.update', ['customerPackage' => $customerPackage]) }}" method="POST">
                    @csrf
                    <div class="mb-3">
                        ...
                        <select name="package_id" id="" class="form-control">
                            ...
                            @foreach($packages as $package)
                                <option value="{{$package->id}}" {{$customerPackage->package_id == $package->id ? 'selected' : '' }}>{{$package->name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="mb-3">
