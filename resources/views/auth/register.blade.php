    ...
    <div class="bg-white p-8 rounded shadow-md w-96">
        ...
        <form action="{{route('register')}}" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="password" id="confirm-password" name="confirm_password" autocomplete="current-password" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md">
            </div>
            <div>
                <button type="submit" class="w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700 focus:outline-none focus:bg-indigo-700">Register</button>
            </div>
        </form>
    </div>
</div>
